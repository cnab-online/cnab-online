...
(function(process) {
  ...
  var ChromeBrowser = function(baseBrowserDecorator, args) {
    ...
    this._getOptions = function(url) {
      ...
      return ['--user-data-dir=' + this._tempDir, '--no-default-browser-check', '--no-first-run', '--disable-default-apps', '--disable-popup-blocking', '--disable-translate', '--disable-background-timer-throttling'].concat(flags, [url]);
    };
  };
